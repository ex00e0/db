...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 13 2024 г., 12:34
...
CREATE TABLE `couriers` (
  ...
  `status` enum('Свободен','Занят') COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_remove` date NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, '2024_12_12_111909_create_categories_table', 1),
...
CREATE TABLE `orders` (
  ...
  `status` enum('Создан','Назначен','Выполнен') COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `products` (
  ...
  `compound` text COLLATE utf8mb4_unicode_ci NOT NULL,
